---
title: "Gene plot of TP53TG1 (AR associated lncRNA) - Supp"
...
plotTracks(list(gtrack, dTrack,arbtrack,frbtrack, atactrack, atrack,grtrack), from = start(target)-10000, to = end(target) + 10000, type = "histogram",ylim = c(-50,0), cex.title = 1.3, sizes=c(1,2,1,1,1,1,2) ) 
dev.off()

jpeg("/Users/ds/Desktop/plot.jpeg", height = 600)
plotTracks(list(gtrack, dTrack,arbtrack,frbtrack, atactrack, atrack,grtrack), from = start(target) -10000, to = end(target) + 10000, type = "histogram",ylim = c(-30,0), cex.title = 1.3, sizes=c(1,2,1,1,1,1,2) ) 
dev.off()
